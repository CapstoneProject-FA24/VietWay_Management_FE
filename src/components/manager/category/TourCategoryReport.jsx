...
import { fetchSocialMediaTourCategoryDetail } from '@services/ReportService';
        ...
        return (
            <Box sx={{
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                    Số tour du lịch: {data.totalTourTemplate || 0}
                </Typography>
                <Typography variant="body2">
...
const TourCategoryReport = ({ categoryId }) => {
    ...
    useEffect(() => {
        const loadCategoryData = async () => {
            ...
            try {
                setLoading(true);
                const data = await fetchSocialMediaTourCategoryDetail(
                    categoryId, 
...
export default TourCategoryReport;