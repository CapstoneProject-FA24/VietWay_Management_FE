      ...
      <Box sx={{ flexGrow: 1, transition: 'margin-left 0.3s', marginLeft: isSidebarOpen ? '250px' : '0', padding: 5, overflowY: 'auto' }}>
        ...
        <TableContainer component={Paper}>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: 'center', padding: '10px' }}>ID</TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, padding: '10px' }}></TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, padding: '10px' }}></TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: 'center', padding: '10px' }}>Số điện thoại</TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: 'center', padding: '10px' }}>Ngày sinh</TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: 'center', padding: '10px' }}>Nơi ở</TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: 'center', padding: '10px' }}>Giới tính</TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: !isSidebarOpen ? 'left' : 'center', padding: '10px', pl: !isSidebarOpen ? '2%' : 0 }}>Trạng thái</TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: 'center', padding: '10px' }}>Ngày tạo</TableCell>
                <TableCell sx={{ width: 'auto', fontWeight: 700, textAlign: 'center', padding: '10px' }}></TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {sortedCustomers.map((customer) => (
                <TableRow key={customer.id}>
                  ...
                  <TableCell noWrap sx={{ pt: '10px', pb: '10px', pl: '5px', pr: 0 }}>
                  ...
                  <TableCell sx={{ textAlign: 'center', padding: '10px' }}>{customer.liveProvince}</TableCell>
