...
import { Box, Typography, List, ListItem, ListItemIcon, ListItemText, Divider, Paper, IconButton, Badge } from '@mui/material';
...
const SidebarManager = ({ isOpen, toggleSidebar }) => {
  ...
  const [unreadNotifications, setUnreadNotifications] = useState(3); // Replace with actual notification count
